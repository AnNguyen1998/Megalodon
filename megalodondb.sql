...
-- Dumping data for table megalodondb.users: ~1 rows (approximately)
...
INSERT INTO `users` (`Id_users`, `Name_users`, `Username_users`, `Password_users`, `Email_users`, `Phone_users`, `Image_users`, `Address_users`, `Date_of_birthday`, `Gender`, `Id_role`, `Status`) VALUES
	(4, 'aaa', 'a', '$2a$10$z8RJnQzheKjYt8kTkCYYnuPT1BQAJIfeVchCyqBfGsngiIjbDZi2C', 'aaaaa', NULL, NULL, NULL, NULL, NULL, 1, NULL),
	(7, '123', 'b', '$2a$10$z8RJnQzheKjYt8kTkCYYnuPT1BQAJIfeVchCyqBfGsngiIjbDZi2C', 'asd', NULL, NULL, NULL, NULL, NULL, 3, NULL),
	(8, NULL, '123', '$2a$10$cCiFPK0w5L0ZlaY.SVZ0luOWjWJ4bKPv8APC2rc9U6QxLczwNUgmK', 'q,123@gmail.comn', NULL, NULL, NULL, NULL, NULL, 3, NULL);
