...
public class GamesDtoAn {
	...
	private Set<GameCategoryDtoAn> gameCategories = new HashSet<GameCategoryDtoAn>(0);
	...
	public Set<GameCategoryDtoAn> getGameCategories() {
		return gameCategories;
	}
	public void setGameCategories(Set<GameCategoryDtoAn> gameCategories) {
